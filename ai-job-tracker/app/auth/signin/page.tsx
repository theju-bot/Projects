    ...
    <div className='min-h-screen flex items-center justify-center bg-background'>
      <div className='p-8 border border-border bg-card rounded-2xl w-full max-w-sm space-y-6'>
        ...
        <button
          ...
          disabled={isPending}
          className='w-full border border-input bg-background hover:bg-secondary hover:text-foreground active:bg-secondary/80 transition-colors rounded-xl py-3 px-4 text-sm font-medium flex items-center justify-center gap-3 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed'
        >
          {isPending ? (
            <>
